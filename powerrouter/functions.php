...
function twentyseventeen_scripts() {
	...
	// wp_enqueue_style( 'css1', get_theme_file_uri( '/assets/css/css1.css' ), array( 'twentyseventeen-style' ), '1.0' );
	// wp_enqueue_style( 'css2', get_theme_file_uri( '/assets/css/css2.css' ), array( 'twentyseventeen-style' ), '1.0' );
...
require get_parent_theme_file_path( '/inc/icon-functions.php' );
 ...
 add_action( 'init', 'sb_taxonomy');

  function sb_taxonomy() {
  ...
  $labels = array(
    ...
    'new_item_name'     => __( 'New Support Category' ),
  ...
  register_taxonomy( 'supports_category_tax','supports',  $args );
